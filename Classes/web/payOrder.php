                ...
                if($result == true)
                {
                    ...
                    if($resultCartItem == true)
                    {
                        foreach(Session::get('cart') as $data){
                            ...
                            $newQuantity =$data['quantityProduct'] - $data['quantity'];
                            $sql = "UPDATE `product` SET QuantityProduct = $newQuantity WHERE IdProduct = $idProduct";
                            $resultSetProduct = $this->db->update($sql);
                        }
                        unset($_SESSION['cart']);
                    }
