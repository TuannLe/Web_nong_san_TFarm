...
<?php
    class feedback
    {
        ...
        public function checkFeedback($idOrder, $idAccount, $idProduct)
        {
            $query = "SELECT * FROM `feedback` where IdProduct= '$idProduct' AND IdAccount='$idAccount' AND IdOrder = '$idOrder'";
