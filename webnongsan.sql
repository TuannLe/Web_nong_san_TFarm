...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 10, 2021 lúc 01:52 PM
...
(33, 'thicu@gmail.com', '25d55ad283aa400af464c76d713c07ad', 'Tuấn Lê', NULL, 1, '2002-02-28', NULL, 'trYXNf3Q4oOTgAua.jpg', 0),
(34, 'tuanle02@gmail.com', '25d55ad283aa400af464c76d713c07ad', 'Lê Đức Anh Tuấn', NULL, 1, '2002-02-28', NULL, 'Hdc629FVlez7srQU.jpg', 0);
...
INSERT INTO `feedback` (`IdVote`, `Title`, `Rate`, `IdProduct`, `IdAccount`, `IdOrder`) VALUES
(79, '<p>Sản phẩm rất tươi, ngon</p>\n', 5, 23, 11, 20442644),
(80, '<p>Sản phẩm tốt, giao h&agrave;ng nhanh ch&oacute;ng</p>\n', 5, 27, 11, 20442644),
(81, '<p>Very good</p>\n', 5, 32, 11, 20442644);
...
(12, 'Nghệ An', 0, 123456789, 'Lê Đức Anh Tuấn'),
(13, 'Nghệ An', 0, 123456789, 'Lê Đức Anh Tuấn'),
(14, 'Đà Nẵng', 1, 123456789, 'Nguyễn Văn D'),
(26, 'Nghệ An', 0, 123456789, 'Lê Đức Anh Tuấn'),
(28, 'Nghệ An', 0, 123456789, 'Lê Đức Anh Tuấn'),
(30, 'Nghệ An', 0, 123456789, 'Lê Đức Anh Tuấn'),
(31, 'Đà Nẵng', 1, 123456789, 'Lê Đức Anh Tuấn'),
(31, 'Nghệ An', 0, 123456789, 'Lê Đức Anh Tuấn'),
(33, 'Nghệ An', 1, 123456789, 'Lê Đức Anh Tuấn'),
(34, 'Đà Nẵng', 0, 123456789, 'Lê Đức Anh Tuấn'),
(34, 'Hưng Nguyên, Nghệ An', 1, 123456789, 'Lê Đức Anh Tuấn');
...
(11926158, 33, '2021-12-09 09:03:29', 'Tuấn Lê', 123456789, 'Nghệ An', 10000, 'Thanh toán khi nhận hàng(COD)', 2, 'thicu@gmail.com'),
...
(44880642, 34, '2021-12-09 09:43:19', 'Lê Đức Anh Tuấn', 123456789, 'Hưng Nguyên, Nghệ An', 40000, 'Thanh toán khi nhận hàng(COD)', 2, 'tuanle02@gmail.com'),
(46749313, 34, '2021-12-09 14:12:43', 'Lê Đức Anh Tuấn', 123456789, 'Hưng Nguyên, Nghệ An', 31000, 'Thanh toán khi nhận hàng(COD)', 3, 'tuanle02@gmail.com'),
(46931231, 13, '2021-12-03 11:06:55', 'Nguyễn Văn C', 123456789, 'Nghệ An', 40000, 'Thanh toán khi nhận hàng(COD)', 2, 'khach4@gmail.com'),
...
(79777535, 11, '2021-12-10 19:49:14', 'Hoàng Thủy', 123456789, 'Quảng Bình', 21000, 'Thanh toán khi nhận hàng(COD)', 3, 'khach2@gmail.com'),
(82711424, 12, '2021-11-30 15:58:37', 'Nguyễn Văn B', 968604438, 'Nghệ An', 403000, 'Thanh toán khi nhận hàng(COD)', 2, 'khach3@gmail.com'),
...
--
ALTER TABLE `account`
  MODIFY `IdAccount` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `feedback`
  MODIFY `IdVote` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
ALTER TABLE `feedback`
  ...
  ADD CONSTRAINT `feedback_ibfk_3` FOREIGN KEY (`IdOrder`) REFERENCES `order` (`IdOrder`);
