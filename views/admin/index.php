        ...
        <div class="row m-gutter">
          ...
          <div class="col l-3 m-6 c-12">
            <div class="container-counter-item">
              ...
              <div class="container-counter-item-wrap">
                <input id="total" type="text" value="<?php echo $order->get_total() ?>" hidden>
                <span id="renderTotal" class="container-counter__quantity"></span>
                <i class='container-counter__icon bx bx-coin-stack'></i>
              </div>
              <script>
                const total = document.getElementById('total').value;
                const elementTotal = document.getElementById('renderTotal');
                ...
                elementTotal.innerHTML = formatCash(total);
              </script>
            </div>
          </div>
        </div>
                ...
                ?>
                        <div class="top-product-item">
                          ...
                          <div class="top-product-item-price">
                            ...
                            <input class="price" type="text" value="<?php echo $data['Price'] ?>" hidden>
                            <h4 id="priceRender" class="top-product-item__name"><?php echo $data['Price'] ?></h4>
                          </div>
                        </div>
                <?php
                      }
