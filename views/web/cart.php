                                ...
                                <script>
                                    ...
                                    function increment(Object) {
                                        ...
                                        if (oldValue < 100) {
                                            ...
                                            divTotal.innerHTML = formatCash(String(total)) + ' đ';
                                        }
                                    }
                                    ...
                                    function addCart(id, object) {
                                        ...
                                        $.ajax({
                                            ...
                                            $('#totalPay').text(formatCash(item[2]) + ' đ');
                                    ...
                                    function deleteCart(id, Object) {
                                        $.ajax({
                                            ...
                                            $('#sumOrder').text(item[0]);
                                            $('#sum_Order').text(item[1]);
                                            $('#totalPay').text(formatCash(item[2]));
                                            $('#listCart').html(item[3])
                                        });
                            ...
                            <div class="cart-pay-bottom">
                                ...
                                <div class="cart-pay-bottom-wrap-right">
                                    ...
                                    <div class="cart-pay-bottom__sum-product-wrap js-cart-pay-bottom__sum-product-wrap">
                                        ...
                                        ?>
                                        <input id="Sum" type="text" value="<?php echo $total; ?>" hidden> 
                                        <div class="cart-pay-bottom__total-pay" id="totalPay">
                                        </div>
                                    </div>
                                    <script>
                                        const elementRender = document.getElementById('totalPay')
                                        const total = document.getElementById('Sum').value;
                                        elementRender.innerHTML = formatCash(total) + ' đ';
                                    </script>
