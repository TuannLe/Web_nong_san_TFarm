...
<?php
    if (isset($_GET['delete']) && isset($_GET['Address'])) {
        $id = $_GET['delete'];
        $newAddress = $_GET['Address'];
        $deleteAddress = $address->delete_address($id, $newAddress);
    }
?>
                                                ...
                                                <div class="user-container-body__address">
                                                    <div class="user-container-body__address-name">
                                                        ...
                                                        <div class="user-container-body__address-action">
                                                            <a class="js-action user-container-body__address-btn--edit" href="user_updateAddress.php?Address=<?php echo $data['Address'] ?>&idAccount=<?php echo $data['IdAccount'] ?>">
                                                                Sửa
                                                            </a>
                                                            <a class="user-container-body__address-btn"  onClick="return confirm('Bạn có muốn xóa không?')" href="?delete=<?php echo $data['IdAccount'] ?>&Address=<?php echo $data['Address'] ?>">
                                                                Xóa
                                                            </a>
                                                        </div>
                                                    </div>
