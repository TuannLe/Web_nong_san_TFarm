...
<?php
$product = new product();
if (!isset($_GET['IdProduct']) || $_GET['IdProduct'] == NULL || !isset($_GET['IdOrder']) || $_GET['IdOrder'] == NULL)
                        ...
                        ?>
                                <div class="user-container">
                                    ...
                                    <div class="evaluate-body__footer">
                                        ...
                                        <input type="text" value="<?php echo $idOrder ?>" hidden id="idOrder">
                                ...
                                <script>
                                    document.getElementById("btn").onclick = function() {
                                        ...
                                        IdOrderElement = document.getElementById('idOrder');
                                        IdOrder = IdOrderElement.value;
